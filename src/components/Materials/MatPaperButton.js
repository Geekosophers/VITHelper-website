...
export class MatPaperButton extends React.Component {
  ...
  showImage() {
    ...
    setTimeout(() => {
      ...
      database
        .ref(`users/${this.props.user_id}/`)
        .update({ coins: this.state.coins + 30 });
    }, 10000);
  }
              ...
              <div className="button button--link">
                {this.state.count != 1 ? (
                  window.location.pathname == "/blogs" ? (
                    ...
                    <span>Blogs</span>
                  ) : null || window.location.pathname == "/npm-package" ? (
                    <span>Blogs</span>
                  ) : null || window.location.pathname == "/placement-guide" ? (
                    <span>Blogs</span>
                  ) : null ||
                    window.location.pathname == "/placement-experience" ? (
                    <span>Blogs</span>
                  ) : null || window.location.pathname == "/faqs" ? (
                    <span>FAQs</span>
                  ) : null || window.location.pathname == "/about-us" ? (
                    <span>About Us</span>
                  ) : null || window.location.pathname == "/cat1papers" ? (
                    <span>CAT-1 Papers</span>
                  ) : null || window.location.pathname == "/cat2papers" ? (
                    <span>CAT-2 Papers</span>
                  ) : null || window.location.pathname == "/fatpapers" ? (
                    <span>FAT Papers</span>
                  ) : null || window.location.pathname == "/placements" ? (
                    <span>Placements</span>
                  ) : null ||
                    window.location.pathname == "/placements/article" ? (
                    <span>Reviews</span>
                  ) : null ||
                  ...
                  ) : null || window.location.pathname == "/placements/pat" ? (
                    <span>PAT-Rules and Regulations</span>
                  ) : null
                ) : (
                  <span>MENU:</span>
                )}
            ...
            {this.state.count == 1 && (
              <div>
                <div className="ham__nav" onClick={this.handleState}>
                  ...
                  >
                    <span>&#x25BA;</span>{" "}
                    <span>Get started with making NPM packages</span>
                  </Link>
                  <Link
                    to="/placement-guide"
                    className="button button--link-for-matheader"
                  ...
                  >
                    <span>&#x25BA;</span>{" "}
                    <span>Guide for Placement preparation</span>
                  </Link>
                  <Link
                  ...
                  >
                    <span>&#x25BA;</span>{" "}
                    <span>
                      Placement experience - Travelling from VIT Chennai to
                      Vellore
                    </span>
                  </Link>
                  <div className="button button--link">
                  ...
                  <Link
                    to="/placements/article"
                    className="button button--link-for-matheader"
                  >
                    &#x25BA; Reviews
                  </Link>
                  <Link
                    to="/placements/topics"
                    className="button button--link-for-matheader"
                  >
                    &#x25BA; Important Topics
                  </Link>
                  <Link
                    to="/placements/advice"
                    className="button button--link-for-matheader"
                  >
                    &#x25BA; Advice
                  </Link>
