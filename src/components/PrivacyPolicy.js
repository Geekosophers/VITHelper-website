  ...
  return (
    <div>
      ...
      <div className="content-container" style={{paddingBottom:'50px'}}>
        ...
        <p style={{color:"#84d0d0"}}><b>Last updated December 13, 2020</b></p>
        <p>Thank you for choosing to be part of our community at VITHelper . We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at contact@vithelper.in.</p>
        <p>When you visit our website <a href="https://vithelper.in"><u>https://vithelper.in</u></a> (the <b>"Website"</b>), use our mobile application, as the case may be (the <b>"App"</b>) and more generally, use any of our services (the <b>"Services"</b>, which include the Website and App), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.</p>
        ...
        <div><a href="#section1" style={{color:"#84d0d0"}}><b><u>1. WHAT INFORMATION DO WE COLLECT?</u></b></a></div>
        <div><a href="#section2" style={{color:"#84d0d0"}}><b><u>2. HOW DO WE USE YOUR INFORMATION?</u></b></a></div>
        <div><a href="#section3" style={{color:"#84d0d0"}}><b><u>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</u></b></a></div>
        <div><a href="#section4" style={{color:"#84d0d0"}}><b><u>4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</u></b></a></div>
        <div><a href="#section5" style={{color:"#84d0d0"}}><b><u>5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</u></b></a></div>
        <div><a href="#section6" style={{color:"#84d0d0"}}><b><u>6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</u></b></a></div>
        <div><a href="#section7" style={{color:"#84d0d0"}}><b><u>7. HOW LONG DO WE KEEP YOUR INFORMATION?</u></b></a></div>
        <div><a href="#section8" style={{color:"#84d0d0"}}><b><u>8. DO WE COLLECT INFORMATION FROM MINORS?</u></b></a></div>
        <div><a href="#section9" style={{color:"#84d0d0"}}><b><u>9. WHAT ARE YOUR PRIVACY RIGHTS?</u></b></a></div>
        <div><a href="#section10" style={{color:"#84d0d0"}}><b><u>10. CONTROLS FOR DO-NOT-TRACK FEATURES</u></b></a></div>
        <div><a href="#section11" style={{color:"#84d0d0"}}><b><u>11. DO WE MAKE UPDATES TO THIS NOTICE?</u></b></a></div>
        <div><a href="#section12" style={{color:"#84d0d0"}}><b><u>12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</u></b></a></div>
        <div><a href="#section13" style={{color:"#84d0d0"}}><b><u>13. HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</u></b></a></div>
        ...
        <p><b>Personal Information Provided by You.</b> We collect email addresses; and other similar information.</p>
        <p><b>Social Media Login Data.</b> We may provide you with the option to register with us using your existing social media account details, like your Google Sign In, Apple Sign In or other social media account. If you choose to register in this way, we will collect the Information described in the section called <a href="#section5" style={{color:"#84d0d0"}}><b><u>"HOW DO WE HANDLE YOUR SOCIAL LOGINS"</u></b></a> below.</p>
        <p>All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.</p>

        <h3 id="section2">2. HOW DO WE USE YOUR INFORMATION?</h3>
        ...
        <p>&#9679; <b>To facilitate account creation and logon process.</b> If you choose to link your account with us to a third-party account (such as your Google or Apple account), we use the information you allowed us to collect from those third parties to facilitate account creation and logon process for the performance of the contract. See the section below headed <a href="#section5" style={{color:'#84d0d0'}}><b><u>"HOW DO WE HANDLE YOUR SOCIAL LOGINS"</u></b></a> for further information.</p>
        ...
        <h3 id="section3">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h3>
        ...
        <h3 id="section5">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3>
        ...
        <p>Our Services offers you the ability to register and login using your third-party social media account details (like your Google or Apple logins). Where you choose to do this, we will receive certain profile information about you from your social media provider. The profile Information we receive may vary depending on the social media provider concerned, but will often include your name, email address and profile picture.</p>
        <p>We will use the information we receive only for the purposes that are described in this privacy notice or that are otherwise made clear to you on the relevant Services. Please note that we do not control, and are not responsible for, other uses of your personal information by your third-party social media provider. We recommend that you review their privacy notice to understand how they collect, use and share your personal information, and how you can set your privacy preferences on their sites and apps.</p>

        <h3 id="section6">6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h3>
        <p><b>In Short:</b> We are not responsible for the safety of any information that you share with third-party providers who advertise, but are not affiliated with, our Website.</p>
        ...
        <h3 id="section7">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h3>
        ...
        <p>If you have questions or comments about your privacy rights, you may email us at contact@vithelper.in.</p>
        ...
        <h3 id="section10">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h3>
        ...
        <h3 id="section11">11. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
        ...
        <h3 id="section12">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h3>
        <p>If you have questions or comments about this notice, you may email us at contact@vithelper.in</p>

        <h3 id="section13">13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
